  ...
  return (
    <section className="relative overflow-hidden bg-gradient-hero min-h-screen flex items-center">
      ...
      <div className="absolute inset-0 opacity-20">
        ...
        <div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-violet-500 rounded-full blur-3xl animate-glow"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in-up">
            ...
            <p className="text-xl text-primary-foreground/80 mb-8 max-w-2xl mx-auto lg:mx-0">
              Smarter savings, powered by AI. Get personalized offers and
              rewards from verified brands — tailored just for you.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button
                variant="outline"
                size="lg"
                className="bg-primary-foreground/10 border-primary-foreground/20 text-primary-foreground hover:bg-primary-foreground hover:text-primary backdrop-blur-sm"
              >
                Learn More
              </Button>
            </div>
