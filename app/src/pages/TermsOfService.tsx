...
import { termsOfServiceContent } from "@/constants/legalContent";
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex items-center gap-2 text-primary-foreground/80">
              ...
              <span className="text-sm">Last updated: {termsOfServiceContent.lastUpdated}</span>
            </div>
          </div>
        </div>
      </div>
            ...
            <CardContent className="p-8 sm:p-12">
              <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none
                ...
                <div className="mt-12 p-6 bg-accent/5 border border-accent/20 rounded-lg">
                  <h3 className="text-lg font-semibold text-foreground mb-2">Agreement Acceptance</h3>
                  <p className="text-muted-foreground mb-4">
                    By using Savv8, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
                  </p>
