        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl">
            <div className="flex items-center gap-2 text-primary-foreground/80 mb-4">
              ...
              <span className="text-sm font-medium">Website Cookies</span>
            </div>
            ...
            <div className="flex items-center gap-2 text-primary-foreground/80">
              ...
              <span className="text-sm">Last updated: {cookiePolicyContent.lastUpdated}</span>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="prose prose-sm sm:prose-base lg:prose-lg max-w-none
                ...
                <div className="mt-12 p-6 bg-accent/5 border border-accent/20 rounded-lg">
                  ...
                  <p className="text-muted-foreground mb-4">
                    You can manage your cookie preferences at any time through your browser settings or by contacting our support team.
                  </p>
